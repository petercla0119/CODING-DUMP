...
t=cal.getAveragedPixelSizeMicrons() //echelle pixel/micron
...
0.step X1.size(),2,{
    ...
    def newPassClass=getPathClass(classname,ColorTools.makeRGB(18,255,87))
...
print 'sampling done'
//print 'Sampling for ' + getProjectEntry().getImageName() + ' Complete!' 