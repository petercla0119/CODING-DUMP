...
//comment out line below if running analysis on cells.
...
//runPlugin('qupath.imagej.detect.tissue.PositivePixelCounterIJ', '{"downsampleFactor": 1,  "gaussianSigmaMicrons": .5,  "thresholdStain1": 15,  "thresholdStain2": 0.32,  "addSummaryMeasurements": true,  "clearParentMeasurements": true,  "appendDetectionParameters": false,  "legacyMeasurements0.1.2": false}');
//comment out line below if running analysis on cells.
